    ...
    <div className="bg-gray-100 dark:bg-gray-900 px-4">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md w-full max-w-xl sm:px-4 md:px-8 transition-colors duration-300">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button
            type="submit"
            className="btn bg-rose-700 hover:bg-rose-800 text-white dark:bg-gray-600 dark:text-white w-full mt-4 py-2 text-sm rounded-lg transition-colors duration-300"
          >
            Sign Up
          </button>
          ...
          <p className="text-sm mt-2 text-center text-gray-700 dark:text-gray-300">
            ...
            <Link href="/login" className="text-rose-600 dark:text-blue-400 hover:underline">
              Login
            </Link>
          </p>
        </form>
